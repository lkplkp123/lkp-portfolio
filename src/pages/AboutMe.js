                ...
                <Container>
                    <Box sx={{
                        ...
                        <Grid container spacing={2}>
                            <Grid spacing={0}
                                direction="column" item xs={12} lg={6} sx={{
                            ...
                            <Grid container
                                ...
                                <Fade bottom>   <Box sx={{ typography: 'p', color: '#a8a8a8', marginTop: 2 }}>Over 3 year 5 months of strong experience as MERN Stack web-developer with understanding of front-end technologies, MVC frameworks, Restful web services and Data Base designing

                                </Box>
                                    {/* <Box sx={{ typography: 'p', color: '#a8a8a8', marginTop: 2 }}>
